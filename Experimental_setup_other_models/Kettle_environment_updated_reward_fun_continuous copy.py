...
class SimpleKettleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        min_power = 0.0
        max_power = 3000.0
        self.action_space = spaces.Box(low=min_power, high=max_power, shape=(1,), dtype=np.float32)
    ...
    def step(self, action):
        ...
        power = action[0]  # Continuous power value from action
        self.step_count += 1
    ...
    def reward_function(self, state ,action ,next_state):
        ...
        energy_used = action[0] * self.dt  # Energy used this step in Joules
